...
function Home(props) {
  ...
  return (
    <div className="flex flex-col flex-1 slider-container mx-40 justify-center items-center">
      <div className={"flex justify-center"}>
        <Slider slideImages={slideImages}/>
        <div className={"text-white ml-20 w-2/6 text-left"}>
          ...
          <section className={"kanit-extralight text-sm space-y-2 text-stone-200"}>
